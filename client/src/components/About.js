    ...
    <div className="profile">
      ...
      <div className='me'>
        ...
        <h4 className='mestory'> My name is Terrence Robertson, I'm from Houston Texas and grew up in a lower class area called Rosewood.
          I've always dreamed big and knew I was destined for all great things. After the passing of my beloved Grandmother "name", 
          I inher some property. Years later, the property next to mine, wasnt interested in keeping their land and sold it for $7000. 
          Even though at that time I had no idea what I wanted to do with the property, i dwelled n the fact that It was mine.
      ...
      <h5 className='end'>Below I'd like to share some photos from my experience and hopefuly to encourage and motivate all that I can. We all can do it, Where you want to go is the key
      Any question are concers, head over to the Public page and ask me there, I will respond at my earliest convenience</h5>
